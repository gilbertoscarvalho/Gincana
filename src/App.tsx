...
export default function App() {
  ...
  const fallbackAudioUrl = 'https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3?filename=peaceful-piano-112199.mp3';
  const rawAudioUrl = settings.backgroundMusicUrl && settings.backgroundMusicUrl.trim() !== '' ? settings.backgroundMusicUrl : fallbackAudioUrl;
  const formattedAudioUrl = formatAudioUrl(rawAudioUrl);
  const hasAudioTrack = true; // Always enable the hymn switch on the homepage and navbar
