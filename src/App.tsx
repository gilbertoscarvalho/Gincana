  ...
  const [settings, setSettings] = useState<EventSettings>(() => {
    try {
      ...
      if (saved) {
        ...
        if (parsed.backgroundMusicUrl && (parsed.backgroundMusicUrl.includes('peaceful-piano') || parsed.backgroundMusicUrl.includes('pixabay.com'))) {
          parsed.backgroundMusicUrl = '';
          parsed.backgroundMusicTitle = '';
          parsed.backgroundMusicEnabled = false;
        }
        return {
          ...parsed,
