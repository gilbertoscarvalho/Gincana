...
export interface EventSettings {
  ...
  teams?: EventTeam[];        // Equipes da gincana em competição
  ...
  proofPhoneNumber?: string;  // Campo legado (opcional)
  whatsappGroupUrl?: string;  // Link oficial do Grupo do WhatsApp para envio de comprovantes
  pixKey?: string;            // Chave PIX oficial
  ...
  backgroundMusicUrl?: string; // URL ou áudio base64 do hino em .mp3
  backgroundMusicTitle?: string; // Título do hino (ex: "Hino 260 - Sou Feliz com Jesus")
  backgroundMusicEnabled?: boolean; // Se o hino está ativado para tocar na tela inicial
}
