...
import { Home as HomeIcon, UserPlus, FileCheck, BarChart3, Users, Settings, Sparkles, Sun, Moon } from 'lucide-react';
    ...
    <header className="bg-slate-900 text-white border-b border-amber-500/20 sticky top-0 z-40 shadow-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between py-3.5 gap-3">
          ...
          {/* Right Header Section: Theme Toggle & TopBarAccess Widget */}
          <div className="flex items-center justify-end gap-2.5 w-full sm:w-auto border-t sm:border-0 border-slate-800/80 pt-2 sm:pt-0">
            {onToggleTheme && (
              <button
