...
export const AdminSettings: React.FC<AdminSettingsProps> = ({
  ...
  const [galleryList, setGalleryList] = useState<GalleryMediaItem[]>(
    Array.isArray(settings.galleryItems) ? settings.galleryItems : DEFAULT_GALLERY_ITEMS
  );
  ...
  useEffect(() => {
    if (settings) {
      ...
      if (Array.isArray(settings.galleryItems)) setGalleryList(settings.galleryItems);
    }
  }, [settings]);
  ...
  // Upload local photo file with compression
