          ...
          <div className="bg-slate-950 border border-slate-800 p-5 rounded-2xl space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-0.5">
                  Configure o hino ou louvor que os visitantes podem ouvir ou desligar na tela inicial do evento.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="Ex: Hino 260 - Sou Feliz com Jesus"
                ...
                />
                <p className="text-[11px] text-slate-400">
                  Exibido na barra e no player de áudio na página inicial para os irmãos e jovens.
                </p>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-300 block">
                  Arquivo ou Link do Hino (.MP3)
                </label>

                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <label className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-slate-900 border border-dashed border-slate-700 hover:border-amber-500 rounded-xl text-xs font-semibold text-amber-300 cursor-pointer transition-colors ${isUploadingAudio ? 'opacity-70 pointer-events-none' : ''}`}>
                      {isUploadingAudio ? (
                      ...
                      <span className="truncate max-w-[200px]">
                        {isUploadingAudio ? 'Enviando áudio...' : audioFileName ? audioFileName : 'Enviar Arquivo .MP3'}
                      </span>
                      <input
                        type="file"
                  ...
                  <input
                    ...
                    placeholder="Ou cole o link do Google Drive / MP3 direto (https://...)"
                    className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-amber-200 font-mono focus:outline-none focus:border-amber-500"
                  />
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-900/80 p-4 rounded-xl border border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <span className="text-[10px] text-amber-400/90 flex items-center gap-1 mt-0.5">
                      ...
                      {previewAudioPlaying ? 'Reproduzindo teste do áudio...' : 'Clique para testar o som'}
                    </span>
                  </div>
                  ...
                  <audio
                    ref={audioPreviewRef}
                    src={formatAudioUrl(backgroundMusicUrl)}
                ...
                <div className="text-[11px] text-slate-400 flex items-center gap-2">
                  <span className="px-2 py-0.5 rounded bg-slate-950 border border-slate-800 text-slate-300 font-mono text-[10px]">
                    {backgroundMusicUrl.startsWith('data:') ? 'Arquivo Local Gravado' : 'Link Web / Drive'}
                  </span>
                </div>
              </div>
            )}
            ...
            {/* Instruction Tip */}
            <div className="p-3 bg-slate-900/50 border border-slate-800/80 rounded-xl space-y-1 text-[11px] text-slate-400">
              <p className="font-semibold text-amber-400 flex items-center gap-1.5">
                💡 Dica para links do Google Drive:
              </p>
              <p className="text-[10px] leading-relaxed">
                Você pode subir o arquivo .mp3 do hino no seu Google Drive, clicar em <strong>Compartilhar &gt; Qualquer pessoa com o link</strong> e colar o link aqui. O sistema converte automaticamente para reprodução direta sem travar!
              </p>
            </div>
          </div>
