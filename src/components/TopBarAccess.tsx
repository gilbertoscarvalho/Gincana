      ...
      <div className="flex items-center gap-2">
        {isAdminUnlocked ? (
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-amber-400 text-slate-950 hover:from-amber-400 hover:to-amber-300 text-xs font-black transition-all shadow-md shadow-amber-500/20 cursor-pointer active:scale-95"
          >
