...
const DEFAULT_SETTINGS: EventSettings = {
  ...
  googleMapsEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3896.670711455419!2d-38.93708902493298!3d-12.404963687860697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTLCsDI0JzE3LjkiUyAzOMKwNTYnMDQuMyJX!5e0!3m2!1spt-BR!2sbr!4v1786794586966!5m2!1spt-BR!2sbr',
  congregations: [
    'Central',
    'Jardim Primavera',
    'Vila Nova',
        ...
        if (res.ok) {
          ...
          if (cloudData.settings && typeof cloudData.settings === 'object') {
            cachedSettings = {
              ...
              galleryItems: Array.isArray(cloudData.settings.galleryItems)
                ? cloudData.settings.galleryItems
                : (cachedSettings?.galleryItems || DEFAULT_SETTINGS.galleryItems)
            };
            try {
...
// Auto-sync database to Vercel Blob
...
async function saveSettings(settings: EventSettings): Promise<void> {
  ...
  await syncBackupToVercelBlobInBackground(cachedParticipants || loadParticipants(), settings);
}
...
async function saveParticipants(participants: Participant[]): Promise<void> {
  ...
  await syncBackupToVercelBlobInBackground(participants, cachedSettings || loadSettings());
}
...
app.put('/api/participants/:id/proof', async (req: Request, res: Response) => {
  const { id } = req.params;
