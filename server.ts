...
// Handle Vercel pre-parsed bodies gracefully so express body-parser does not throw "stream is not readable"
...
const DEFAULT_SUPABASE_ANON_KEY = DEFAULT_SUPABASE_PUBLISHABLE_KEY;
